    ...
    <View>
      ...
      <View style={Styles.columnTextInputStyle}>
        ...
        <CustomInputText
          name={'الرقم السرى'}
          title={'اكتب هنا...'}></CustomInputText>
        <Text style={Styles.forgotPasswordTextStyle}>نسيت الرقم السرى؟</Text>
      </View>
      <View style={Styles.loginButtonStyle}>
        ...
        <Text style={Styles.dontHaveAccountStyle}>ليس لديك حساب ؟</Text>
        ...
        <Pressable
          ...
          <Text style={Styles.loginButtonStyle}> سجل حساب جديد الان</Text>
        </Pressable>
      </View>
    </View>
  );
